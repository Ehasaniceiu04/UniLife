...
using Semerkand.Server.Middleware.Extensions;
...
namespace Semerkand.Server.Middleware
{
    ...
    public class APIResponseRequestLoggingMiddleware
    {
        ...
        public APIResponseRequestLoggingMiddleware(RequestDelegate next, bool enableAPILogging, IConfiguration configuration)
        {
            ...
            _ignorePaths = configuration.GetSection("Semerkand:ApiLogging:IgnorePaths").Get<List<string>>();
        }
