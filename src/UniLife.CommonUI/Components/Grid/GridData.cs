...
namespace GridData
{
    ...
    public class EmployeeOrders
    {
        ...
        public static List<EmployeeOrders> GetAllRecords()
        {
            ...
            order.Add(new EmployeeOrders(10283, "LILAS", 3, DateTime.Now.AddDays(++count), DateTime.Now.AddDays(++count), DateTime.Now.AddDays(++count), 84.81, "LILA-Supermercado", "Carrera 52 con Ave. Bolívar #65-98 Llano Largo", "BarquAdeto", "Lara", "3508", "Venezuela"));
            ...
            order.Add(new EmployeeOrders(10296, "LILAS", 6, DateTime.Now.AddDays(++count), DateTime.Now.AddDays(++count), DateTime.Now.AddDays(++count), 0.12, "LILA-Supermercado", "Carrera 52 con Ave. Bolívar #65-98 Llano Largo", "BarquAdeto", "Lara", "3508", "Venezuela"));
            ...
            order.Add(new EmployeeOrders(10330, "LILAS", 3, DateTime.Now.AddDays(++count), DateTime.Now.AddDays(++count), DateTime.Now.AddDays(++count), 12.75, "LILA-Supermercado", "Carrera 52 con Ave. Bolívar #65-98 Llano Largo", "BarquAdeto", "Lara", "3508", "Venezuela"));
            ...
            order.Add(new EmployeeOrders(10357, "LILAS", 1, DateTime.Now.AddDays(++count), DateTime.Now.AddDays(++count), DateTime.Now.AddDays(++count), 34.88, "LILA-Supermercado", "Carrera 52 con Ave. Bolívar #65-98 Llano Largo", "BarquAdeto", "Lara", "3508", "Venezuela"));
            ...
            order.Add(new EmployeeOrders(10381, "LILAS", 3, DateTime.Now.AddDays(++count), DateTime.Now.AddDays(++count), DateTime.Now.AddDays(++count), 7.99, "LILA-Supermercado", "Carrera 52 con Ave. Bolívar #65-98 Llano Largo", "BarquAdeto", "Lara", "3508", "Venezuela"));
    ...
    public class Employee
    {
        ...
        public static List<Employee> GetAllRecords()
        {
            ...
            Emp.Add(new Employee(2, "Andrew", "Fuller", "Vice President, Sales", new DateTime(1952, 02, 19), new DateTime(1992, 08, 14), 4, "908 W. Capital Way", "98122 ", "(206) 555-9482 ", "Kirkland ", "USA", "andrew_fuller@gmail.com"));
